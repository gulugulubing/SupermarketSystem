...
DROP TABLE IF EXISTS `smb_address`;

CREATE TABLE `smb_address` (
...
insert  into `smb_role`(`id`,`roleCode`,`roleName`,`createdBy`,`creationDate`,`modifyBy`,`modifyDate`) values (1,'SMB_ADMIN','系统管理员',1,'2016-04-13 00:00:00',NULL,NULL),(2,'SMB_MANAGER','经理',1,'2016-04-13 00:00:00',NULL,NULL),(3,'SMB_EMPLOYEE','普通员工',1,'2016-04-13 00:00:00',NULL,NULL);


DROP TABLE IF EXISTS `smb_user`;
...
insert  into `smb_user`(`id`,`userCode`,`userName`,`userPassword`,`gender`,`birthday`,`phone`,`address`,`userRole`,`createdBy`,`creationDate`,`modifyBy`,`modifyDate`)
